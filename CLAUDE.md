...
- 3 sprint: `/fill-cycle` (capacity gap analysis), `/generate-backlog` (MEGA backlog generation), `/roadmap` (strategic visibility — theme progress, milestones, ROADMAP.md generation)
