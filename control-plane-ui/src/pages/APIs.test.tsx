...
vi.mock('../services/api', () => ({
  apiService: {
    ...
    getApis: vi.fn().mockResolvedValue([
      ...
      { id: 'api-2', tenant_id: 'oasis-gunters', name: 'user-api', display_name: 'User API', version: '2.0.0', description: 'User management service', backend_url: 'https://users.example.com', status: 'draft', deployed_dev: false, deployed_staging: false, tags: ['users'], created_at: '2024-01-05T00:00:00Z', updated_at: '2024-01-10T00:00:00Z' },
    ]),
    createApi: vi.fn(),
    updateApi: vi.fn(),
    deleteApi: vi.fn(),
