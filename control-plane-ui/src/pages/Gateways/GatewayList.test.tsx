...
vi.mock('../../services/api', () => ({
  apiService: {
    getGatewayInstances: vi.fn().mockResolvedValue({
      items: [
        { id: 'gw-1', name: 'stoa-edge-mcp-1', display_name: 'STOA Edge MCP Gateway', gateway_type: 'stoa_edge_mcp', environment: 'dev', base_url: 'https://mcp.gostoa.dev', auth_config: {}, status: 'online', capabilities: ['mcp', 'openapi', 'rate_limiting'], tags: ['production'], mode: 'edge-mcp', created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-15T00:00:00Z' },
        { id: 'gw-2', name: 'webmethods-prod', display_name: 'webMethods Production', gateway_type: 'webmethods', environment: 'prod', base_url: 'https://wm.example.com', auth_config: {}, status: 'degraded', capabilities: ['rest', 'soap'], tags: ['legacy'], created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-10T00:00:00Z' },
      ],
      total: 2,
    }),
