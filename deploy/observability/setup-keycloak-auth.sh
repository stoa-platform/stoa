...
if [ -z "$1" ]; then
  ...
  echo "1. Go to https://auth.stoa.cab-i.com"
...
echo "  - Grafana:    https://grafana.stoa.cab-i.com (native OIDC)"
echo "  - Prometheus: https://prometheus.stoa.cab-i.com (via oauth2-proxy)"
echo "  - Loki:       https://loki.stoa.cab-i.com (via oauth2-proxy)"
echo ""
