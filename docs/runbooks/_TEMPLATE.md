...
|-------|-----------|-----------|
| `AlertName` | condition | [Dashboard Link](https://grafana.gostoa.dev/d/xxx) |
...
- [Main dashboard](https://grafana.gostoa.dev/d/xxx)
- [Detailed dashboard](https://grafana.gostoa.dev/d/yyy)
