...
|-------|-----------|-----------|
| `AlertName` | condition | [Dashboard Link](https://grafana.dev.apim.cab-i.com/d/xxx) |
...
curl -s https://<service>.dev.apim.cab-i.com/health | jq .
...
- [Main dashboard](https://grafana.dev.apim.cab-i.com/d/xxx)
- [Detailed dashboard](https://grafana.dev.apim.cab-i.com/d/yyy)
