...
> Dernière MAJ: 2026-02-16 (session 16 — CAB-374 MEGA + CAB-1291 + CAB-1154)
...
- CAB-1154: Algolia DocSearch LIVE (1 pt) — stoa-docs PR #49
- CAB-1291: API Test Coverage & Quality (34 pts) — PR #576 (142 tests, 14 modules)
- CAB-374: Deployment Lifecycle MEGA (34 pts) — 3 phases, 3 repos
  - CAB-1353: Deployment Lifecycle API (8 pts) — PR #570
  - CAB-1354: Deploy Event Notifications (5 pts) — PR #570
  - CAB-1352: ADR-045 Deployment Lifecycle (5 pts) — stoa-docs PR #56
  - CAB-1355: Console UI Deployment Dashboard (8 pts) — PR #573
  - CAB-1356: stoactl deploy commands (5 pts) — stoactl PR #7
  - CAB-1357: E2E BDD Deployment Lifecycle (3 pts) — PR #574
...
- ~~CAB-1154~~ Algolia DocSearch LIVE (PR #49), Announcement bar (separate repo)
