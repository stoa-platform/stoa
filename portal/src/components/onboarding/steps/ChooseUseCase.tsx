  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-neutral-500 dark:text-neutral-400">{t('chooseUseCase.subtitle')}</p>
      </div>
        ...
        {USE_CASES.map((uc) => {
          ...
          return (
            <button
              ...
              className="group relative bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 hover:border-primary-400 dark:hover:border-primary-500 hover:shadow-lg transition-all text-left"
            >
              <div
              ...
              <p className="text-sm text-neutral-500 dark:text-neutral-400">{t(uc.descKey)}</p>
            </button>
          );
        })}
      </div>
