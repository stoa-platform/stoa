  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <div className="flex-1 relative">
          <input
            ...
            disabled={disabled}
            className="w-full px-3 py-2.5 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-neutral-100 dark:disabled:bg-neutral-700 disabled:cursor-not-allowed font-mono text-sm dark:bg-neutral-800 dark:text-white"
          />
        </div>
      ...
      <div className="text-xs text-neutral-500 dark:text-neutral-400">
        ...
        <code className="bg-neutral-100 dark:bg-neutral-700 px-2 py-0.5 rounded break-all">
          {buildFullUrl()}
        </code>
      </div>
        ...
        {activeTab === 'params' && (
          <div className="space-y-2">
            {queryParams.map((param, index) => (
              <div key={index} className="flex items-center gap-2">
                ...
                <input
                  ...
                  placeholder="Key"
                  disabled={disabled}
                  className="flex-1 px-3 py-1.5 border border-neutral-300 dark:border-neutral-600 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-neutral-100 dark:disabled:bg-neutral-700 dark:bg-neutral-800 dark:text-white"
                />
                <input
                  type="text"
                  value={param.value}
                ...
                <button
                  ...
                  disabled={disabled}
                  className="p-1.5 text-neutral-400 dark:text-neutral-500 hover:text-red-500 dark:hover:text-red-400 transition-colors disabled:opacity-50"
                >
            ...
            <button
              ...
              disabled={disabled}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded-lg transition-colors disabled:opacity-50"
            >
        ...
        {activeTab === 'body' && showBodyTab && (
          <div className="space-y-2">
            ...
            <textarea
              ...
              disabled={disabled}
              rows={8}
              className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg font-mono text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-neutral-100 dark:disabled:bg-neutral-700 disabled:cursor-not-allowed resize-y dark:bg-neutral-800 dark:text-white"
            />
          </div>
        )}
      </div>
