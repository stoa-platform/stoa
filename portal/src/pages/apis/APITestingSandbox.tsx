        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <button
              ...
              className="mt-4 px-4 py-2 text-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg text-sm font-medium transition-colors"
            >
              Back to API Catalog
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      <span
                        ...
                        ${item.method === 'PUT' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400' : ''}
                        ${item.method === 'DELETE' ? 'bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400' : ''}
                        ${item.method === 'PATCH' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400' : ''}
                      `}
                      >
                        {item.method}
                      </span>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <span
                        ...
                        ${item.status >= 300 && item.status < 400 ? 'text-blue-600 dark:text-blue-400' : ''}
                      `}
                      >
                        {item.status}
                      </span>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-800 p-4">
            <h3 className="font-medium text-blue-900 dark:text-blue-300 mb-2">Testing Tips</h3>
