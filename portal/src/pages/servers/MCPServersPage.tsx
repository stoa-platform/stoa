 ...
 * AI Tools Page
 *
 * Browse AI Tools (grouped tool collections) with role-based visibility.
 * - Platform tools (admin-only) shown only to cpi-admin/tenant-admin/devops
 * - Tenant tools visible to all tenant members
...
const categoryConfig: Record<ServerCategory, {
  ...
  public: { label: 'Public Tools', icon: Globe, description: 'Publicly available tools' },
};
